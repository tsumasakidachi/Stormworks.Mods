...
mesh_compiler fluid_radiator_electric_5x5x1.dae -o ./
mesh_compiler fluid_radiator_electric_fan_5x5x1.dae -o ./
component_mod_compiler fluid_radiator_electric_5x5x1.xml fluid_radiator_electric_5x5x1.mesh fluid_radiator_electric_fan_5x5x1.mesh
move fluid_radiator_electric_5x5x1.bin ../../tsu_components/data/components
